...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppFooterFooterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 16,
      vars: 0,
      consts: [[1, "container", "mt-5"], [1, "row", "py-4", "d-flex", "align-items-center", "justify-content-center", "shadow-sm"], [1, "col-6", "text-white", "ml-auto", "font-22"], [1, "col-6", "text-gray"], [1, "float-right", "text-center"], ["onclick", " window.open('https://www.linkedin.com/in/pranay-nagavolu/');", 1, "m-2"], ["src", "assets/in.png", "alt", "", 1, "img-fluid", "pointer", "img-size"], ["href", "mailto:pranay12430.nagavolu@gmail.com", 1, "m-2"], ["src", "assets/mail.png", "alt", "", 1, "img-fluid", "pointer", "img-size"], ["onclick", " window.open('https://www.instagram.com/pranay_nagavolu/');", 1, "m-2"], ["src", "assets/insta.png", "alt", "", 1, "img-fluid", "pointer", "img-size"], ["onclick", " window.open('https://gitlab.com/PranayNagavolu');", 1, "m-2"], ["src", "assets/gitlab.png", "alt", "", 1, "img-fluid", "pointer", "img-size"], ["onclick", " window.open('https://github.com/PranayNagavolu');", 1, "m-2"], ["src", "assets/github.svg", "alt", "", 1, "img-fluid", "pointer", "img-size"]],
